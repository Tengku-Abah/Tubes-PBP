        ...
        <div className="relative bg-white shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden rounded-md border border-slate-100">
          ...
          <div className="p-4">
            ...
            {isLoggedIn ? (
              ...
              <button 
                onClick={handleAddToCart}
                className="w-full py-3.5 px-4 text-sm font-bold bg-primary-600 text-white rounded-lg hover:bg-primary-700 active:scale-[0.98] shadow-md hover:shadow-lg transition-all duration-200"
              >
                <span className="flex items-center justify-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
